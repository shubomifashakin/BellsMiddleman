export function CheckBox({ setChecked, checked }) {
  return (
    <span
      ...
      className={`group relative flex w-14 cursor-pointer rounded-full border border-stone-700 bg-white px-1.5 py-1 transition-all duration-300 ease-in-out hover:bg-stone-700 `}
    >
      <span
